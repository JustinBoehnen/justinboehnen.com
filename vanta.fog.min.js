...
!(function (e, t) {
	...
	return (function (e) {
		...
		function (e, t, i) {
			...
			;(r.register = (e, t) => (r[e] = (e) => new t(e))), (r.version = '0.5.18')
			const h = function () {
			...
			;(r.VantaBase = class {
					...
					try {
						...
						return (
							...
							void (
								...
								(this.el.style.background = Object(o.a)(this.options.backgroundColor)))
							)
						)
					}
				...
				applyCanvasStyles(e, t = {}) {
					Object(o.c)(e.style, { position: 'absolute', zIndex: 0, top: 0, left: 0, background: '' }),
		...
		function (e, t, i) {
			...
			class r extends o.b {
				...
				init() {
					;(this.mode = 'shader'),
						(this.uniforms = {
							...
							iMouse: { type: 'v2', value: new s.Vector2(this.mouseX || 0, this.mouseY || 0) },
						}),
						super.init(),
				...
				initBasicShader(e = this.fragmentShader, t = this.vertexShader) {
					...
					const i = new s.ShaderMaterial({ uniforms: this.uniforms, vertexShader: t, fragmentShader: e }),
						o = this.options.texturePath
					o && (this.uniforms.iTex = { type: 't', value: new s.TextureLoader().load(o) })
